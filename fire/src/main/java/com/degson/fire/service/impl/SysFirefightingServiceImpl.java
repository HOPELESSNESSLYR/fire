...
//    }
    ...
    public String generateStream(String qrContent) throws WriterException {
        // 中文说明：调用二维码工具的静态方法，生成二维码流（Base64或其他形式）
...
//                log.error(msg, e);
    ...
    @Override
    public java.util.List<com.degson.fire.domain.vo.MonthlySummaryVO> queryMonthlySummary(String startDate, String endDate) {
        // 中文说明：委托给 Mapper 层根据日期范围做分组统计，并返回聚合后的 VO 列表
        return sysFirefightingMapper.selectMonthlySummary(startDate, endDate);
    }
}
