<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="检查流水主键" align="center" prop="recordId" />
      <el-table-column label="设备主键" align="center" prop="fireId" /> -->
      ...
      <el-table-column label="检查时间" align="center" prop="checkRecords"  width="180"/>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除检查记录编号为"' + recordIds + '"的数据项？').then(function() {
